...
def smo_plus_srt(text_corpus, index, tokenizer, vocab, max_len, is_last=False):
    ...
    masked_tokens, labels, label_positions = smo_prep.mask_spans(tokens, tokenizer, vocab, token_length)
    ...
    return {
        ...
        "bert_label": {"SMO": smo_labels, "SRT": srt_label},
