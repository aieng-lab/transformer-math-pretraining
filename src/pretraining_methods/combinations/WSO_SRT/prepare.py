...
def wso_plus_srt(text_corpus, index, tokenizer, vocab, max_len, is_last=False):
    ...
    wso_tokens, labels, label_positions = wso_prep.shuffle_words(tokens, tokenizer, vocab, token_length)
    ...
    return {
        ...
        "bert_label": {"WSO": wso_labels, "SRT": srt_label},
